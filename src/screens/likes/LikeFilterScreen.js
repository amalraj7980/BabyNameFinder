...
import {styles} from './likeFilterScreenStyles';

import RangeSlider from 'react-native-range-slider'; // Import the range slider component

export default function LikeFilterScreen({navigation, route}) {
  const {
    locale: {locale, code},
    likeFilterScreen, // Access filterData from AppContext
    setLikeFilterScreen, // Access setFilterData from AppContext
  ...
  const handleFilterChange = (field, value) => {
    if (field === 'compoundLetter') {
      setLikeFilterScreen(prevFilter => ({
        ...prevFilter,
  ...
  useEffect(() => {
    ...
    setIsCompoundSwitchOn(likeFilterScreen.compoundLetter);
    setValue(likeFilterScreen.gender);
  }, [likeFilterScreen]);
  ...
  const handleSearch = () => {
    ...
    route.params.onFilterApplied(likeFilterScreen);
    // Go back to BabyNamesScreen
    navigation.navigate('LikeList', {filter: likeFilterScreen});
    // navigation.goBack();
  };
          ...
          {rowOptions.map(option => (
            <View key={option.value} style={styles.radioButtonContainer}>
              ...
              <RadioButton
                ...
                status={
                  likeFilterScreen.gender === option.value
                    ? 'checked'
                    : 'unchecked'
        ...
        <View style={styles.card}>
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={likeFilterScreen.firstLetter}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={likeFilterScreen.lastLetter}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={likeFilterScreen.contains}
