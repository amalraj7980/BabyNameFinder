...
export default function SearchScreen({navigation, route}) {
  const {
    ...
    setSeachfilterDataWholeNames, // Access setFilterData from AppContext
  ...
  const handleFilterChange = (field, value) => {
    if (field === 'compoundLetter') {
      setSeachfilterDataWholeNames(prevFilter => ({
        ...prevFilter,
  ...
  useEffect(() => {
    ...
    setIsCompoundSwitchOn(seachfilterDataWholeNames.compoundLetter);
    setValue(seachfilterDataWholeNames.gender);
  ...
  const handleSearch = () => {
    ...
    route.params.onFilterApplied(seachfilterDataWholeNames);
    // Go back to BabyNamesScreen
    navigation.navigate('TheWholeLIst', {filter: seachfilterDataWholeNames});
    // navigation.goBack();
  };
          ...
          {rowOptions.map(option => (
            <View key={option.value} style={styles.radioButtonContainer}>
              ...
              <RadioButton
                ...
                status={
                  seachfilterDataWholeNames.gender === option.value
                    ? 'checked'
                    : 'unchecked'
        ...
        <View style={styles.card}>
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={seachfilterDataWholeNames.firstLetter}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={seachfilterDataWholeNames.lastLetter}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              value={seachfilterDataWholeNames.contains}
