...
import {styles} from './mainSearchScreenStyles';
...
export default function MainSearchScreen({navigation, route}) {
  ...
  const [filter, setFilter] = useState({
    firstLetter: '',
    lastLetter: '',
    gender: 'all', // Set a default value
    contains: '',
    compoundLetter: false, // Changed variable name here
  });
